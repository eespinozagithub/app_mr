...
{
    public partial class CreaTablaVueltas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdRegionCarga = table.Column<int>(type: "int", nullable: false),
                    IdRegionDescarga = table.Column<int>(type: "int", nullable: false),
                    CiudadesIdCiudad = table.Column<int>(type: "int", nullable: true),
